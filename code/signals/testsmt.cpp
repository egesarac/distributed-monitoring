...
int main()
{
    ...
    */
    ofstream results;
    string filename = "results_wt.txt";
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        while (getline(sigdata, line))
        {
            ...
            double t, v;
            linestream >> t >> v;
            signals[i].push_back(make_pair((long long)(t * 1000), v));
        }
        sigdata.close();
    }
    ...
    results << d << " " << eps << " " << del << " " << numSegments << " " << (totalTime.count() / REP) / 1000 << " " << falseAtZero << " " << trueAtZero << endl;
    cout << d << " " << eps << " " << del << " " << numSegments << " " << (totalTime.count() / REP) / 1000 << " " << falseAtZero << " " << trueAtZero << endl;
