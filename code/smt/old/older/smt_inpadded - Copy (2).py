...
def prog_always_disjunction(eps, segCount, data_0, data_1):
    ...
    #         var_0.append(i)
    # var_0.append(data_0[-1][0])

    # var_1 = [0]
    # for i in range(1, len(data_1)):
    #     if (data_1[i][1] != data_1[i - 1][1]):
    #         var_1.append(i)
    # var_1.append(data_1[-1][0])
    ...
    while entryFound:
        ...
        for j in range(segmentLowerBound, segmentUpperBound):
            ...
            if j >= 0 and j < len(data_0) - 1:
                ...
                if (j == 0 or (data_0[j][0] in var_0 and data_0[j][0] > segmentLowerBound)):
        ...
        for j in range(segmentLowerBound, segmentUpperBound):
            ...
            if j >= 0 and j < len(data_1) - 1:
                ...
                if (j == 0 or (data_1[j][0] in var_1 and data_1[j][0] > segmentLowerBound)):
    ...
    for d in (4, 8, 16, 32):
        for eps in (1, 2, 4, 8):
            ...
            for c in range(100):
                ...
                print(line)
                results = open("results_ad_smt+neg2.txt", "a")
                results.write(line + "\n")
                results.close()
