...
We assume that the values of $\delta$ and $\varepsilon$ are known by the monitor.

\subsection{Uncertainty Regions and Signal Retiming}
.
%todo: define a function from timestamps to segments, maybe using a proper retiming?
...
%todo: add conjunction to syntax and semantics, add destuttering to semantics of each operation
