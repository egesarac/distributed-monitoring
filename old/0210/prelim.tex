...
We denote by $\B = \{ \bot, \top \}$ the set of boolean truth values, $\R$ the set of reals, $\R_{\geq 0}$ the set of nonnegative reals, and $\R_{> 0}$ the set of positive reals.
...
\TODO: use stl with quantitative semantics instead?
...
\TODO: notation $w[t..]$ (to fix in ltl3?)
