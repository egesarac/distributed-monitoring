...
\rednote{this assumption should be integrated somewhere below}
...
\rednote{maybe here, if T and T' are not distant enough then the same signal cannot have an edge?}
