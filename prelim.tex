...
$$ \varphi :=  p ~|~ \lnot \varphi ~|~ \varphi \land \varphi ~|~ \varphi \until \varphi ~|~ \LTLf_I \varphi ~|~ \LTLg_I \varphi$$
...
We implicitly assume that the time values $t,t',t'' \in [0,d)$ are within the signals' temporal domain.
\begin{align*}
	...
	[w,t \models \varphi_1 \until \varphi_2] &\iff \exists t' > t : [w,t' \models \varphi_2] \land \forall t'' \in (t, t') : [w,t'' \models \varphi_1] \\
...
We additionally use the following standard abbreviations: $\true = p \lor \lnot p$, $\false = \lnot \true$, $ \varphi_1 \lor \varphi_2 = \lnot \varphi_1 \land \lnot \varphi_2$, $\LTLf \varphi = \true \until \varphi$, $\LTLg \varphi = \lnot \LTLf \lnot \varphi$.
