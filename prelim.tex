...
\begin{definition} \label{defn:hb}
	...
	\begin{itemize}
		...
		\item Every pair of events whose timestamps are at least $2 \varepsilon$ apart is totally ordered, i.e., for all $1 \leq i,j \leq n$ and all $(t, x_i(t)) \in E_i$ and $(t', x_j(t')) \in E_j$, if $t + 2\varepsilon \leq t'$ then $(t, x_i(t)) \hb (t', x_j(t'))$. \ege{To be confirmed: $t + 2\varepsilon \leq t'$ or $t + 2\varepsilon < t'$?}
	\end{itemize}
\end{definition}
...
%Moreover, for all $T,T' \in \R_{\geq 0}$ and $1 \leq i \leq n$ where $A_j = \pi(x_i)$, (i) if $T < T'$, then for every pair of events $(c_j(T), x_i(c_j(T))) \in f(T)$ and $(c_j(T'), x_i(c_j(T'))) \in f(T')$ we have $(c_j(T), x_i(c_j(T))) \hb (c_j(T'), x_i(c_j(T')))$, and
%(ii) if $T < T'$ and $T + \delta > T'$, then for every pair of events $(c_j(T), x_i(c_j(T))) \in f(T)$ and $(c_j(T'), x_i(c_j(T'))) \in f(T')$ we have $(c_j(T), x_i(c_j(T))) \notin D_{x_i}$ or  $(c_j(T'), x_i(c_j(T'))) \notin D_{x_i}$.
...
%\alert{Moreover, if we further have $T + \delta > T'$, then $(c_j(T), x_i(c_j(T))) \notin D_{x_i}$ or  $(c_j(T'), x_i(c_j(T'))) \notin D_{x_i}$.}
