...
Below we recall the infinite-trace qualitative semantics of STL defined over $\B$. \ege{The same semantics can be applied to finite traces and infinite traces separately.}
