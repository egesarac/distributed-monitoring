...
%	[w,t \models \varphi_1 \until \varphi_2]_j &= \max_{t \leq t' \leq d} \left( \min \left( [w,t' \models \varphi_2]_P, \min_{t \leq t'' \leq t'} \left( [w,t'' \models \varphi_1]_P \right) \right) \right)\\
