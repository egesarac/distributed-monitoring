...
\begin{document}
	...
	\begin{enumerate}
		...
		\item The values of the atomic propositions stay the same for at least $\delta > 0$ time units after each change with respect to the local clock of the monitor. The value of the greatest lower bound on $\delta$ is known by the monitor. \rednote{to confirm}
