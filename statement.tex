...
Moreover, we write $\tr(S,{\hb},\delta)$ for the largest subset of $\tr(S,{\hb})$ where all signals of all concrete traces satisfy the bounded variability assumption with the constant $\delta$. \ege{To be confirmed.}
