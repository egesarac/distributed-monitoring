...
Mixing conjunctive and disjunctive modalities (i.e., universal and existential quantifiers) leads to increased FPs, although combining ADM and EDM still yields considerable speedup, as can be seen for $\varphi_4$ and $\varphi_5$.
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Results on monitoring $\varphi_{4}$ to $\varphi_{5}$ on distributed traces created by the RG.}
