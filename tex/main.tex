...
\title{Aprroximate Distributed Monitoring under Partial Asynchrony: Balancing Speed with Accuracy} 
\author{Borzoo Bonakdarpour\inst{1} \and Anik Momtaz\inst{1} \and Dejan Ni\v{c}kovi\'{c}\inst{2} \and Ege Sarac\inst{3}} %
\institute{Michigan State University \and AIT Austrian Institute of Technology \and IST Austria} %
...
\begin{document}
	...
	\begin{abstract}
		...
		This conservative abstraction enables a significal speedup of the distributed monitors, albeit with a trade-off in accuracy. We address this 
		...
		efficiency without sacrifying precision. We validate our approach with multiple experiments, showcasing its effectiveness and efficacy on 
