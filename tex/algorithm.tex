...
Lastly, we also consider a decentralized setting where each agent has a monitor running on it, reducing asynchrony by using the agent's clock as a reference point.
