...
The operators $\mathsf{E}$ and $\mathsf{A}$ respectively correspond to \emph{eventually} and \emph{always}.
...
\end{align*}
\normalsize
%From these, we also derive $L_1 \lor L_2 =  $\LTLeventually L_1 = \{1\} \until L_1$, and $\LTLalways L_1 = \lnot \LTLeventually \lnot L_1$
