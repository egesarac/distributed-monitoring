...
\begin{abstract}
	...
	with a trade-off in accuracy. We address this 
	trade-off with a methodology that combines our approximate monitor with its exact counterpart, 
	resulting in enhanced monitoring 
	efficiency without sacrificing precision. We validate \borzoo{evaluate} our approach with multiple 
	experiments, 
	showcasing its effectiveness and efficacy on 
