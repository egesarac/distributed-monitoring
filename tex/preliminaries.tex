...
\begin{example}
	\alert{TODO: distributed signal, happened-before relation, consistent cut, frontier, consistent cut flow}
	
	Let $(S,{\hb})$ be a distributed signal with $S = (x_1, x_2)$ where 
\end{example}
