...
Throughout the paper, we assume that $\varphi$ is \emph{copyless}, i.e., each signal $x \in S$ occurs in $\varphi$ at most once. %%% this may be not wlog -- the verdict may change when a formula is made copyless
