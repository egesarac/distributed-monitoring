...
system).
%
We first demonstrated that in our synthetic experiments, our approximate monitors achieve 
speed-ups of between 3 and 5.5 orders of magnitudes compared to the exact SMT-based 
...
%
In our case studies, we observe up to 6 orders of magnitude speed-up (although in some cases the 
improvement is not as much). \borzoo{Please check}
%
